if Post.destroy_all && Comment.destroy_all && User.destroy_all
	...
	comment1 = Comment.create({name: "Julie", email: "julie@email.com", user_id: 1, post_id:1, body: "my sexy body" })
	comment2 = Comment.create({name: "Bob", email: "bob@email.com", user_id: 2, post_id:1, body: "my sexy body" })
end
